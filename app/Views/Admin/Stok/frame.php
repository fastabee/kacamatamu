<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-3">Stok Frame</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Transaksi Stok Frame — <span id="lblNamaItem"></span></h5>
...
<div class="modal fade" id="modalRiwayat" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Riwayat Stok Frame — <span id="lblNamaRiwayat"></span></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
...
const tblStok = $('#tblStok').DataTable({
    processing: true,
    serverSide: true,
    ajax: { url: "<?= base_url('stok/frame/datatable') ?>", type: 'GET' },
    columns: [
...
$('#btnSimpanTransaksi').on('click', function () {
    ...
    $.ajax({
        url: "<?= base_url('stok/frame/transaksi') ?>", method: 'POST',
        data: { idframe: $('#txIdItem').val(), jenis: $('#txJenis').val(), jumlah, keterangan: $('#txKeterangan').val() },
...
$(document).on('click', '.btn-riwayat', function () {
    ...
    $.get("<?= base_url('stok/frame/riwayat') ?>/" + iditem, function (res) {
        if (!res.data.length) {
